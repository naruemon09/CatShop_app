                ...
                <div className="row py-4 pb-0 pb-sm-4 align-items-center ">
                    ...
                    <div className="col-sm-4 col-lg-3 text-center text-sm-start">
                        <div className="main-logo">
                            <a href="index.html">
                                <img src="/src/images/cat_logo.png" alt="logo" className="img-fluid" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                        ...
                        <div className="offcanvas-body justify-content-between">
                            ...
                            <ul className="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
                                ...
                                <li className="nav-item">
                                    <a href="https://templatesjungle.gumroad.com/l/waggy-pet-shop-ecommerce-html-website-template" className="nav-link fw-bold text-dark" target="_blank">GET PRO</a>
                                </li>
                            </ul>
